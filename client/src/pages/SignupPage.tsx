      ...
      <div className="card p-8">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            ...
            <input type="email" placeholder="you@amc.seoul.kr"
          ...
          <div>
            ...
            <input type="password" placeholder="8자 이상"
                   ...
                   className="input" minLength={8} autoComplete="new-password" required />
          </div>
          <div>
        ...
        <p className="text-xs text-ink-500 mt-4">
          가입 후 이메일로 6자리 인증코드가 발송됩니다.
        </p>
        <div className="mt-6 text-sm text-ink-500 text-center">
          이미 계정이 있으신가요?{' '}
          <Link to="/login" className="text-brand-600 hover:text-brand-700">로그인</Link>
        </div>
      </div>
    </div>
  );
