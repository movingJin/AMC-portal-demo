            ...
            {!data &&
              [...Array(PAGE_SIZE)].map((_, i) => (
                <tr key={i} className="border-t border-ink-100">
                  ...
                  <td className="px-5 py-3.5">
                    <div className="skeleton h-5 w-10 mx-auto rounded-full" />
                  </td>
                </tr>
              ))}
            {data?.content.map((bm, idx) => (
              ...
              >
                ...
                <td className="px-5 py-3.5 text-center">
                  ...
                  >
                    <span
                      className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ${bm.useYn ? 'translate-x-4' : 'translate-x-0'}`}
                    />
                  </button>
                </td>
              </tr>
