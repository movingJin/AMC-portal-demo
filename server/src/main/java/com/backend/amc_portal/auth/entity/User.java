...
@Getter
@Entity
@Table(name = "users", schema = "portal", uniqueConstraints = @UniqueConstraint(columnNames = "email"))
...
public class User extends BaseTimeEntity {
    ...
    @Builder
    public User(String email, String displayName, String passwordHash, UserRole role, UserStatus status) {
        this.email = email;
    ...
    public void updateDisplayName(String name) { this.displayName = name; }
}
