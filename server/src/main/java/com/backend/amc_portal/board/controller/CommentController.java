...
public class CommentController {
    ...
    public ApiResponse<CommentResponse> create(@AuthenticationPrincipal UserPrincipal p,
    ...
    public ApiResponse<CommentResponse> update(@AuthenticationPrincipal UserPrincipal p,
